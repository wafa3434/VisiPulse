تمت إضافة رسم بياني مخصص لكي يساعد مدير الجودة في مراقبة وتقييم المؤشرات بشكل مرئي داخل واجهته.
إليك الكود المحدث والكامل لقسم الـ IT (مع إضافة الرسم البياني لمدير الجودة بجانب خانة القرارات الإدارية):
